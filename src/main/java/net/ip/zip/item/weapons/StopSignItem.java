...
public class StopSignItem extends GeoWeaponItem {
    public StopSignItem(net.minecraft.world.item.Item.Properties properties) {
        super(Tiers.IRON, 5, -2.6f, properties, "StopSign block", "f1a2b3c4-d5e6-7890-abcd-ef1234567895", false);
    }
