...
import net.ip.zip.client.model.BatItemModel;
import software.bernie.geckolib.renderer.GeoItemRenderer;

public class BaseballBatItem extends GeoWeaponItem {
    private final String batName;

    public BaseballBatItem(String batName, net.minecraft.world.item.Tiers tier, int attackDamage, float attackSpeed, net.minecraft.world.item.Item.Properties properties) {
    ...
    protected GeoItemRenderer<?> createRenderer() {
        return new SimpleGeoItemRenderer<>(new BatItemModel());
    }
}