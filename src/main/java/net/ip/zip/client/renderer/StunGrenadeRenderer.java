...
public class StunGrenadeRenderer extends EntityRenderer<StunGrenadeEntity> {
    public StunGrenadeRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public ResourceLocation getTextureLocation(StunGrenadeEntity entity) {
        return null;
    }

    @Override
    public void render(StunGrenadeEntity entity, float entityYaw, float partialTick, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        poseStack.pushPose();
